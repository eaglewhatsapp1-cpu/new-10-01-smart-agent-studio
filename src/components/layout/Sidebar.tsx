...
export const Sidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: '/knowledge-base', label: t.sidebar.knowledgeBase, icon: Database },
    
    // Build (create agents and workflows)
    { path: '/agents', label: t.sidebar.agents, icon: Bot },
    { path: '/multi-agent-canvas', label: t.sidebar.multiAgentCanvas, icon: Network },
    { path: '/workflow-builder', label: 'AI Workflow Builder', icon: Wand2 },
    
    // Use (interact with agents)
    { path: '/ai-chat', label: 'AI Chat', icon: Sparkles },
    { path: '/agent-test', label: t.sidebar.agentTestChat, icon: MessageSquare },
    
    // Share & Discover
    { path: '/marketplace', label: t.sidebar.marketplace, icon: Store },
    
    // Monitor
    { path: '/workflow-runs', label: 'Workflow Runs', icon: Play },
    { path: '/analytics', label: t.sidebar.analytics, icon: BarChart3 },
